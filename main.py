"""
Main module for presenting Presidents data
"""
import argparse

from data_loader import load_csv_data
from display import display_data
from preprocessor import (select_first_last_born_columns, preprocess_president_column,
                          preprocess_born_column)


def get_input_parameters() -> (str, str, str, str, str, str):
    """
    ...
    parser.add_argument('--born_column', type=str, default='Born', nargs='?',
                        help='Column with president born date')
    ...
    return (args.file_path,
            args.president_column,
            args.born_column,
            args.target_first_column,
            args.target_last_column,
            args.title)
